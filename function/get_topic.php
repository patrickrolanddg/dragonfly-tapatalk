...
{
    global $db, $auth, $prefix, $user, $board_config;
    ...
    $allowed = $auth->acl_get('f_attach', $forum_id) && $auth->acl_get('u_attach') && $board_config['allow_attachments'] && @ini_get('file_uploads') != '0' && strtolower(@ini_get('file_uploads')) != 'off';
