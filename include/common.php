...
function post_content_clean($str){
	...
	$str = preg_replace ("/(\[ame(.+)\])(.*)(\[\/ame\])/siU","[URL$2]$3[/URL]",$str);
...
function post_content_clean_html($str){
	$bbcode_array = array('SIZE','FONT','HIGHLIGHT','LEFT','RIGHT','CENTER','INDENT','EMAIL','THREAD','POST','LIST','CODE','PHP','HTML','NOPARSE','ATTACH','BUG','SCREENCAST');
