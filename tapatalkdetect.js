/*
Note by JM:
This javascript can be called by the website to check if the user is accessing from a mobile device.
If a mobile device is detected, the user can be notified that tapatalk is available for use.
*/
